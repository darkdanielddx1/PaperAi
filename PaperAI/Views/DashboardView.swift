...
// TEK DOKUNUŞ: Swift 6'nın init hatasını çözmek için View'u @MainActor ile işaretledik.
@MainActor
struct DashboardView: View {

    // @State yerine @State var veya @State private var olarak kalsın ama başlangıçta boş bırakıyoruz
    ...
    // KODUNUN ORİJİNAL HALİ: Hiçbir değişiklik yapmadık
    // İlgili init alanını sadece bu şekilde değiştiriyoruz:
        init(
            viewModel: DashboardViewModel? = nil,
            path: Binding<NavigationPath>? = nil
        ) {
            // Eğer dışarıdan bir viewModel verilmediyse, güvenli alanda kendisi oluştursun
